...
def joniFunc() -> bool:
    ...
    ## -------------------------------------------------------------------------------------------------
        ...
        # st.button(label='Delete Account',on_click=au.delete_account,args=[password],type='primary')
